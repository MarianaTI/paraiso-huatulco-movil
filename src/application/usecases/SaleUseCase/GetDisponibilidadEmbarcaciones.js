...
class GetDisponibildadEmbarcaciones {
    ...
    async run(fecha, destino) {
        const getSale = await this.saleRepo.getDisponibildadEmbarcaciones(fecha, destino);
        return getSale;
    }
}

export default GetDisponibildadEmbarcaciones;